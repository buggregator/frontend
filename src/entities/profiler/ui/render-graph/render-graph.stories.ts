      ...
      nodes: [
        {
          data: {
            id: "e10",
            name: "Spiral\\Core\\AbstractCore::callAction",
            color: "#6FB1FC",
          },
        },
        {
          data: {
            id: "e11",
            name: "Spiral\\Core\\AbstractCore::Spiral\\Core\\{closure}",
            color: "#EDA1ED",
          },
        },
        {
          data: {
            id: "e12",
            name: "App\\Controller\\HomeController::email",
            color: "#86B342",
          },
        },
        {
          data: {
            id: "e13",
            name: "Spiral\\SendIt\\MailQueue::send",
            color: "#F5A45D",
          },
        },
        {
