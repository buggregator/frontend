...
export const REST_API_URL = (import.meta.env.VITE_EVENTS_REST_API as string)
  || guessRestApiConnection();

export const WS_URL = (import.meta.env.VITE_EVENTS_WS_API as string)
  || guessWsConnection();
